  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I'm Priyangsu Banerjee. I live in India, where I build the future. I've loved making things for as long as I can remember, and wrote my first program when I was in the 5th grade, just two weeks after I received my first personal computer, that I taught myself to type on. The only thing I loved more than play as a kid was computers. When I was 12, I wrote the first code which was the damn basic calculator with html, css & javascript. Counted up for a moment what i could ever imagine was code code & code. I was passionate enough to solve my daily life problems by just wring some amount code which again started off, by building a simple to-do application."
        />
        <meta
          name="keywords"
      ...
      <div className="lg:mt-0 -mt-24">
        <div className="space-y-10 lg:space-y-0 lg:px-32 flex flex-col lg:flex-row-reverse lg:justify-start">
          <div className="lg:w-1/2 shrink-0 flex flex-col items-center lg:px-16">
            <div className=" w-full  flex items-center justify-center">
              <img
                ...
                className="lg:grayscale h-[400px] lg:h-[350px] lg:hover:h-[500px] w-[500px] object-cover overflow-hidden hover:grayscale-0 transition-all duration-500 cursor-pointer lg:rounded-2xl"
                alt=""
              />
            </div>
            <div className="lg:mt-16 w-full hidden lg:block">
              <ul role="list">
                <li className="flex">
                  <a
                    className="group flex text-sm font-medium transition text-zinc-200 hover:text-sky-300"
                    href="https://twitter.com/oxygenated_fire"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                ...
                <li className="mt-4 flex">
                  <a
                    className="group flex text-sm font-medium transition text-zinc-200 hover:text-sky-300"
                    href="https://github.com/priyangsubanerjee"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                ...
                <li className="mt-4 flex">
                  <a
                    className="group flex text-sm font-medium transition text-zinc-200 hover:text-sky-300"
                    href="https://www.linkedin.com/in/priyangsu-banerjee/"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="h-6 w-6 flex-none fill-slate-500 transition group-hover:fill-sky-300"
                ...
                <li className="mt-8 border-t pt-8 border-zinc-700/40 flex">
                  <a
                    className="group flex text-sm font-medium transition text-zinc-200 hover:text-sky-300"
                    href="mailto:priyangsu@icloud.com"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    ...
                    <span className="ml-4">priyangsu@icloud.com</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="lg:w-1/2 shrink-0 px-5">
            ...
            <div className="mt-16 w-full lg:hidden block">
              <ul role="list">
                <li className="flex">
                  <a
                    className="group flex text-sm font-medium transition text-zinc-200 hover:text-sky-300"

...
function About() {
  return (
    <div>
      <Head>
        <title>About - Priyangsu Banerjee</title>
      </Head>
      <div className="px-5 mt-5 lg:mt-7">
        <div className="space-y-10 lg:px-32 flex flex-col lg:flex-row-reverse lg:justify-start">
          <div className="lg:w-1/2 shrink-0 flex flex-col items-center lg:px-16">
            ...
            <div class="lg:mt-16 w-full hidden lg:block">
              <ul role="list">
                <li class="flex">
                  <a
                    class="group flex text-sm font-medium transition text-zinc-200 hover:text-teal-500"
                ...
                <li class="mt-8 border-t pt-8 border-zinc-700/40 flex">
                  ...
                  >
                    ...
                    <span class="ml-4">priyangsu@icloud.com</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="lg:w-1/2 shrink-0 mt-16">
            ...
            <div class="mt-16 w-full lg:hidden block">
              <ul role="list">
                <li class="flex">
                  <a
                    class="group flex text-sm font-medium transition text-zinc-200 hover:text-teal-500"

  ...
  return (
    <div>
      <div className="flex justify-between space-x-6">
        <div className="w-[50%] shrink-0 space-y-6">
          <h1 className="text-4xl font-bold leading-[1.4] text-gray-700">
            I&apos;m{" "}
            <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              Priyangsu Banerjee
            </span>
            . I live in India, where I design the future.
          </h1>
        ...
        <div className="w-[40%] shrink-0 space-y-16">
          <img
            src="/logo.jpeg"
            alt=""
            className="h-96 grayscale hover:grayscale-0 w-full rounded-xl border object-cover transition-all duration-500"
          />
          <Socials />
          <form
            action="/thank-you"

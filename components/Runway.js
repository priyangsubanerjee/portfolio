    ...
    <div className="flex flex-col h-full mt-7 lg:mt-7">
      <div
        ...
        className={`h-auto my-auto mb-10 flex-grow w-auto ml-16 lg:ml-36 relative
            ${parked ? "bg-[#ffe9e9] dark:bg-[#e344441e] border-l-[2px] border-[#EF4444]" : "bg-neutral-50 dark:bg-neutral-300/10 border-l-[2px] border-black dark:border-white/50"}`}
      >
        ...
        <button id="plane" className={`absolute rotate-180 left-0 z-30 -translate-x-[51%] -translate-y-3 ${parked ? "text-[#EF4444] dark:text-[#EF4444]" : "text-neutral-800 dark:text-white"}`}>
        ...
        ></div>
        <div
          className={`h-full flex items-center relative ${parked ? "opacity-100" : "opacity-0"}
      `}
        >
          <div className="absolute top-3 right-3 text-xs">
            <span className="text-neutral-800 dark:text-neutral-400">0:00:00</span>
          </div>
          <Marquee>
            <div></div>
          </Marquee>

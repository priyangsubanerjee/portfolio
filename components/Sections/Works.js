        ...
        {projects.slice(0, 6).map((project, i) => (
          ...
          >
            <div className="lg:ml-20 transition-all duration-1000">
              ...
              <p className="text-sm max-w-2xl leading-7 text-neutral-600 dark:text-neutral-300 mt-5">{project.description}</p>
            ...
            <div className="ml-auto whitespace-nowrap shrink-0">
              <h1 className="text-2xl lg:text-4xl dark:text-white font-thin">/ {project.year}</h1>
            </div>
          </motion.div>
        ))}

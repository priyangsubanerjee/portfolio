        ...
        <div className="flex items-center rounded-lg bg-darkPrimary border border-darkPrimary p-5 hover:shadow-xl hover:shadow-sky-300/10 transition-all">
          ...
          <div className="ml-5">
            ...
            <div className="flex mt-5">
              <button className="border group w-full border-darkPrimary text-zinc-300 hover:bg-sky-300 hover:text-black px-3 py-3 rounded-lg text-sm ml-auto flex items-center justify-center space-x-2 transition-all duration-700">
                <span>Register now</span>
                <i class="bi bi-arrow-right group-hover:translate-x-2 transition-all"></i>
              </button>
            </div>
          </div>
        </div>
